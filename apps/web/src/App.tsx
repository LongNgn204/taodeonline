...
import BatchExamGenerator from './pages/BatchExamGenerator';
import { VersionHistoryPage } from './pages/VersionHistory';
import NotificationSettings from './pages/NotificationSettings';
import HelpCenter from './pages/HelpCenter';

// PWA Components
import { PWAUpdatePrompt, OfflineIndicator, InstallPWAPrompt } from './components/PWAPrompts';
        ...
        <>
            <Routes>
                ...
                <Route element={user ? <Layout /> : <Navigate to="/login" replace />}>
                    ...
                    <Route path="/batch-exam" element={<BatchExamGenerator />} />
