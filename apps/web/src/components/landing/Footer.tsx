        ...
        <footer className="bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
            <div className="container mx-auto px-4 py-12">
                <div className="grid md:grid-cols-4 gap-8 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center">
                                <span className="text-white font-bold font-sans">K</span>
                            </div>
                            <span className="font-bold text-lg text-gray-900 dark:text-white">Kiến Tạo Việt</span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <li><a href="/guide-7991" className="hover:text-primary-600">Hướng dẫn CV 7991</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> stu725114073@hnue.edu.vn</li>
                ...
                <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
                    <p>© 2025 Ma Trận Đề Thông Minh. All rights reserved.</p>
